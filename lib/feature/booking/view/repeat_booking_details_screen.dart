  ...
  Widget build(BuildContext context) {
    return CustomPopWidget(
      ...
      child: Scaffold(
        ...
        body: widget.bookingId == null ? const NoDataScreen(text: "no_data_found", type: NoDataType.bookings,) :
        DefaultTabController( length: 2,
          child: TabBarView(controller: tabController, children:  [
            RepeatBookingDetailsWidget(tabController: tabController, bookingId: widget.bookingId),
            
            RepeatBookingServiceLogWidget(tabController: tabController, bookingId: widget.bookingId),
          ]),
        ),
