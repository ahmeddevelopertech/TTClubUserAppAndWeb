        ...
        body: GetBuilder<ServiceBookingController>(
          builder: (serviceBookingController){
            ...
            return RefreshIndicator(
              ...
              child: CustomScrollView( physics: AlwaysScrollableScrollPhysics(), controller: bookingScreenScrollController, slivers : [
                ...
                serviceBookingController.bookingList != null ? SliverToBoxAdapter(
                  ...
                  child: bookingList!.isNotEmpty && !serviceBookingController.isTabLoading  ? Center(
      ...
      return PopupMenuButton<String>(
        ...
        child:  Padding(
          ...
          child: Stack(
            ...
            children: [
              Icon(Icons.filter_list, color: ResponsiveHelper.isDesktop(context) && !Get.isDarkMode
