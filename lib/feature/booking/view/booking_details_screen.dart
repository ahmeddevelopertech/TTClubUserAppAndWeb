  ...
  Widget build(BuildContext context) {
    ...
    return CustomPopWidget(
      child: Scaffold(
        ...
        body: widget.bookingID == null && widget.subBookingId == null && widget.token == null 
          ? const NoDataScreen(text: "no_data_found", type: NoDataType.bookings,) 
                ...
                return bookingDetailsContent != null ? Expanded(child: Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                  ...
                  Padding(padding: const EdgeInsets.all(6.0),
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            Text("invoice".tr, style: robotoMedium.copyWith(color: Get.isDarkMode ? Theme.of(context).textTheme.bodyLarge?.color : Theme.of(context).colorScheme.primary, fontSize: Dimensions.fontSizeSmall)),
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeEight, horizontal: Dimensions.paddingSizeLarge),
                      child: Text("review".tr, style: robotoMedium.copyWith(color: Get.isDarkMode ? Theme.of(context).textTheme.bodyLarge?.color : Theme.of(context).colorScheme.onPrimary)
                      ),
                    ),
                  ) : const SizedBox(),
