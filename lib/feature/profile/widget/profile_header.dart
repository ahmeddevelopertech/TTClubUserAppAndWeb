              ...
              children: [
                ...
                isLoggedIn ? Positioned(
                  ...
                  child: GestureDetector(
                    ...
                    child: Row(
                      children: [
                        Text('edit'.tr,style: robotoBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge,color: Get.isDarkMode ? Theme.of(context).textTheme.bodyLarge?.color : Theme.of(context).colorScheme.primary),),
                        const SizedBox(width: Dimensions.paddingSizeExtraSmall,),
                        Icon(Icons.edit,color: Get.isDarkMode ? Theme.of(context).textTheme.bodyLarge?.color : Theme.of(context).colorScheme.primary,size: Dimensions.fontSizeExtraLarge,)
                      ],
                    ),
                  ),
                ): const SizedBox()
