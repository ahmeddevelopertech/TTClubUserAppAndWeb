...
import '../feature/tt_club_landing/presentation/pages/compensation_document_page.dart';
...
class RouteHelper {
  ...
  static String getSignInRoute({String? redirectUrl}) {
    ...
    final isIgnoreRedirection =
        redirectUrl?.contains(RouteHelper.checkout) ?? false;
  ...
  static const String compensationDocument = '/compensation-document';

  static String getCompensationDocumentRoute() => compensationDocument;
  ...
  static String getHtmlRoute(String page, {required String? title}) =>
      '$html?page=$page${title != null ? '&title=$title' : 'vvv'}';
  ...
  static List<GetPage> routes = [
    GetPage(
      name: RouteHelper.compensationDocument,
      page: () => const CompensationDocumentPage(),
    ),
      ...
      page: () => getRoute(
        ResponsiveHelper.isDesktop(Get.context)
            ? AccessLocationScreen(
                fromSignUp: false,
                route: RouteHelper.getMainRoute('home'),
              )
    ...
    GetPage(
      name: internationalLawyers,
      page: () => const InternationalLawyersPage(),
    ),
    ...
    GetPage(
      ...
      page: () => HtmlViewerScreen(
        ...
        pageKey:
            HtmlType.fromValue(Get.parameters['page'] ?? '') == HtmlType.others
            ? Get.parameters['page']
            : null,
      ),
    ),
    ...
    GetPage(
      ...
      page: () =>
          getRoute(ProviderDetailsScreen(providerId: Get.parameters['id']!)),
    ),
    GetPage(
...
class RedirectToHomeMiddleware extends GetMiddleware {
  ...
  RouteSettings? redirect(String? route) {
    ...
    return RouteSettings(name: RouteHelper.home);
  }
}
  ...
  RouteSettings? redirect(String? route) {
    ...
    if (!authController.isLoggedIn()) {
      ...
      return RouteSettings(
        name: RouteHelper.getNotLoggedScreen(
...
class RedirectRouteValidator {
  ...
  static const Set<String> _authenticationRoutes = {
    ...
    RouteHelper.changePassword, // Consider adding this too
  };
