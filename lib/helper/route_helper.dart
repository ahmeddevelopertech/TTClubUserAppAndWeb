...
class RouteHelper {
  ...
  static String getHtmlRoute(String page, { required String? title}) => '$html?page=$page${title != null ? '&title=$title' : 'vvv'}';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: address, page: ()=> AddressScreen(fromPage:Get.parameters['fromProfileScreen']), middlewares: [AuthMiddleware(pageTitle: 'my_address')]),
    ...
    GetPage(name: createPost, page:() => const CreatePostScreen(), middlewares: [AuthMiddleware(pageTitle: 'create_post')]),
