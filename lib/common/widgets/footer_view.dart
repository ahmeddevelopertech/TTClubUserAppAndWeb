                    ...
                    children: [
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 50,
                                    child: ListView.builder(
                                      ...
                                      shrinkWrap: true,
                                      itemCount: activeSocialMediaList.length,
                                      itemBuilder: (BuildContext context, index) {
                                        final item = activeSocialMediaList[index];
                                        String? icon;
                                        ...
                                        switch (item.media) {
                                          ...
                                          case 'pinterest': icon = Images.pinterestIcon; break;
                                        }
                      ...
                      Expanded(flex: 2,child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: Dimensions.paddingSizeLarge),
                          FooterButton(title: 'privacy_policy'.tr, route: RouteHelper.getHtmlRoute(HtmlType.privacyPolicy.value, title: 'privacy_policy'.tr)),
                          const SizedBox(height: Dimensions.paddingSizeSmall),
                          FooterButton(title: 'terms_and_conditions'.tr, route: RouteHelper.getHtmlRoute(HtmlType.termsAndCondition.value, title: 'terms_and_conditions'.tr)),
                          const SizedBox(height: Dimensions.paddingSizeSmall),
                          FooterButton(title: 'about_us'.tr, route: RouteHelper.getHtmlRoute(HtmlType.aboutUs.value, title: 'about_us'.tr)),
                          const SizedBox(height: Dimensions.paddingSizeSmall),
                      ...
                      Expanded(flex: 2,child: Column(
                        ...
                        children: [
                          ...
                          FooterButton(
                            ...
                            route: pickedAddress ? RouteHelper.getSearchResultRoute(fromPage: "popular") : RouteHelper.getPickMapRoute( RouteHelper.allServiceScreen , true, 'false', null, null),
                          ),
                          const SizedBox(height: Dimensions.paddingSizeSmall),
                          FooterButton(
                            title: 'categories'.tr,
